    ...
    with torch.no_grad():
        ...
        for _ in range(args.generate_max_len):
            ...
            for index in range(args.batch_size):
                ...
                for last_word in input_ids[index][-3:-1]:
                    next_token_logits[index][last_word] /= args.repetition_penalty
            # 惩罚上一句的末尾几个字
        ...
        for index in range(args.batch_size):
            ...
            candidate_responses.append(
                "".join(tokenizer.convert_ids_to_tokens(responses)).replace("##", "").replace("<word_space>", " "))
